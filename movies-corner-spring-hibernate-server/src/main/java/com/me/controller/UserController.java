...
public class UserController {
    ...
    public Object register(@RequestBody User user, BindingResult result) throws Exception {
    ...
    @RequestMapping(value = "/users/{userId}",
            ...
            produces = "application/json")
    public Object getUser(@PathVariable String userId, @RequestHeader HttpHeaders headers) throws Exception {
        try {
    ...
    @RequestMapping(value = "/users/search/{userName}",
            method = RequestMethod.GET,
            produces = "application/json")
    public Object searchUsers(@PathVariable String userName) throws Exception {
        try {
    ...
    @RequestMapping(value = "/users/follow/{followingId}",
            method = RequestMethod.POST,
            produces = "application/json")
    public Object follow(@PathVariable String followingId, HttpServletRequest request) throws Exception {
        try {
    ...
    @RequestMapping(value = "/users/unfollow/{unfollowingId}",
            method = RequestMethod.POST,
            produces = "application/json")
    public Object unfollow(@PathVariable String unfollowingId, HttpServletRequest request) throws Exception {
        try {
            User user = (User) request.getAttribute("user");
    ...
    @RequestMapping(value = "/users/followings/{id}",
            method = RequestMethod.GET,
            produces = "application/json")
    public Object getFollowings(@PathVariable String id, @RequestHeader HttpHeaders headers) throws Exception {
        try {
            String requestingUser = "";
            if (headers.get("x-auth-token") == null) {
                requestingUser += "guest";
    ...
    @RequestMapping(value = "/users/followers/{id}",
            method = RequestMethod.GET,
            produces = "application/json")
    public Object getFollowers(@PathVariable String id, @RequestHeader HttpHeaders headers) throws Exception {
        try {
            String requestingUser = "";
            if (headers.get("x-auth-token") == null) {
                requestingUser += "guest";
