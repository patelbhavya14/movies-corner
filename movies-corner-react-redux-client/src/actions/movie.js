...
import {
  ...
  GET_MOVIE_REVIEWS,
  GET_MOVIE_REVIEWS_ERROR,
  GET_RATINGS,
  GET_RATINGS_ERROR,
  GET_TRAILER,
  GET_TRAILER_ERROR,
  GET_USER_RATING_FOR_MOVIE,
  GET_USER_RATING_FOR_MOVIE_ERROR,
  IS_WATCHLIST,
  IS_WATCHLIST_ERROR,
  REMOVE_WATCHLIST,
...
export const getMovieDetails = (movieId) => async (dispatch) => {
  try {
    const res = await axios.get(
      `${tmdbURL}/movie/${movieId}?api_key=${APIKey}`
    );
...
export const getTrailer = (movieId) => async (dispatch) => {
  try {
    const trailer = await axios.get(
      `${tmdbURL}/movie/${movieId}/videos?api_key=${APIKey}`
    );
...
export const addToWatchList = (id, name, image) => async (dispatch) => {
  try {
    ...
    await axios.post(`${springURL}/movies/watchlist/add`, body, setAuthToken());
...
export const removeFromWatchList = (id, name, image) => async (dispatch) => {
  try {
    ...
    await axios.post(
      `${springURL}/movies/watchlist/remove`,
      body,
      setAuthToken()
    );
...
export const getRatings = (id) => async (dispatch) => {
  try {
    const res = await axios.get(`${springURL}/movies/ratings/get/${id}`);
...
export const getUserRatingForMovie = (id) => async (dispatch) => {
  try {
    const res = await axios.get(
      `${springURL}/movies/ratings/users/get/${id}`,
      setAuthToken()
    );
...
export const addRating = (id, name, image, rating) => async (dispatch) => {
  try {
    ...
    await axios.post(
      `${springURL}/movies/ratings/add/${rating}`,
      body,
      setAuthToken()
    );
    dispatch({
...
export const updateRating = (id, name, image, rating) => async (dispatch) => {
  try {
    ...
    await axios.post(
      `${springURL}/movies/ratings/update/${rating}`,
      body,
      setAuthToken()
    );
    dispatch({
...
export const deleteRating = (id, name, image) => async (dispatch) => {
  try {
    ...
    await axios.post(
      `${springURL}/movies/ratings/delete`,
      body,
      setAuthToken()
    );
    dispatch({
...
export const getReviews = (movieId) => async (dispatch) => {
  try {
    const res = await axios.get(`${springURL}/movies/reviews/${movieId}`);
    dispatch({
