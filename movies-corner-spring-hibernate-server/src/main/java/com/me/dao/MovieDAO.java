...
public class MovieDAO extends DAO {
    ...
    public Movie addOrGetMovie(Movie movie, String action) {
        try {
            Movie m = (Movie) getSession().get(Movie.class, movie.getMovieId());
            if (m == null) {
...
//                    + "WHERE r.user.userId=:userId AND m.movieId=:movieId";
            ...
            String hql1 = "SELECT rating FROM Ratings WHERE userId=:userId AND movieId=:movieId";
...
//                    + "WHERE r.user.userId=:userId";
            ...
            String hql1 = "SELECT movie.movieId AS movieId, movie.movieName as movieName, movie.movieImage AS movieImage, rating as rating FROM Ratings WHERE user.userId=:userId";
