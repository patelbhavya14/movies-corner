...
public class MovieController {
    ...
    @RequestMapping(value = "/movies/watchlist/remove",
            method = RequestMethod.POST,
            produces = "application/json")
    public Object removeFromWatchList(@RequestBody Movie movie, HttpServletRequest request) throws Exception {
        User user = null;
        try {
            user = (User) request.getAttribute("user");
    ...
    @RequestMapping(value = "/movies/watchlist",
            method = RequestMethod.POST,
            produces = "application/json")
    public Object isWatchList(@RequestBody Movie movie, HttpServletRequest request) throws Exception {
        User user = null;
        try {
            user = (User) request.getAttribute("user");
            boolean isWatchList;
    ...
    @RequestMapping(value = "/movies/watchlist/{userId}",
            ...
            produces = "application/json")
    public Object getWatchList(@PathVariable String userId) {
        try {
            Set<Movie> watchlist = movieDao.getWatchList(userId);
            System.out.println("MOVIEDAO"+watchlist);
    ...
    @RequestMapping(value = "/movies/ratings/add/{rating}",
            method = RequestMethod.POST,
            produces = "application/json")
    public Object addRatings(@PathVariable String rating, @RequestBody Movie movie, HttpServletRequest request) {
        try {
    ...
    @RequestMapping(value = "/movies/ratings/update/{rating}",
            method = RequestMethod.POST,
            produces = "application/json")
    public Object updateRatings(@PathVariable String rating, @RequestBody Movie movie, HttpServletRequest request) {
        try {
            double r = Double.parseDouble(rating);
            if (r < 0 || r > 10) {
                throw new MovieException("Rating should be in range of 0 to 10");
    ...
    @RequestMapping(value = "/movies/ratings/delete",
            method = RequestMethod.POST,
            produces = "application/json")
    public Object deleteRatings(@RequestBody Movie movie, HttpServletRequest request) {
        try {
            User user = (User) request.getAttribute("user");
    ...
    @RequestMapping(value = "/movies/ratings/get/{movieId}",
            method = RequestMethod.GET,
            produces = "application/json")
    public Object getAvgRatings(@PathVariable String movieId, HttpServletRequest request) {
        try {
    ...
    @RequestMapping(value = "/movies/ratings/users/get/{movieId}",
            method = RequestMethod.GET,
            produces = "application/json")
    public Object getUserRatingsForMovie(@PathVariable String movieId, HttpServletRequest request) {
        try {
            User user = (User) request.getAttribute("user");
    ...
    @RequestMapping(value = "/movies/ratings/users/{userId}",
            method = RequestMethod.GET,
            produces = "application/json")
    public Object getUserRatings(@PathVariable String userId, HttpServletRequest request) {
        try {
//            User user = (User) request.getAttribute("user");
    ...
    @RequestMapping(value = "/movies/reviews/add",
            method = RequestMethod.POST,
            produces = "application/json")
    public Object addReview(@RequestBody String body, HttpServletRequest request) {
        try {
            User user = (User) request.getAttribute("user");
    ...
    @RequestMapping(value = "/movies/reviews/update",
            method = RequestMethod.POST,
            produces = "application/json")
    public Object updateReview(@RequestBody String body, HttpServletRequest request) {
        try {
            User user = (User) request.getAttribute("user");
            if (user.getUserRole() == UserRole.User) {
                throw new MovieException("User is unauthorized");
    ...
    @RequestMapping(value = "/movies/reviews/delete",
            method = RequestMethod.POST,
            produces = "application/json")
    public Object deleteReview(@RequestBody String body, HttpServletRequest request) {
        try {
            User user = (User) request.getAttribute("user");
            if (user.getUserRole() == UserRole.User) {
                throw new MovieException("User is unauthorized");
    ...
    @RequestMapping(value = "/movies/reviews/{movieId}",
            method = RequestMethod.GET,
            produces = "application/json")
    public Object getReviewsForMovie(@PathVariable String movieId, HttpServletRequest request) {
        try {
    ...
    @RequestMapping(value = "/movies/reviews/users/{userId}",
            method = RequestMethod.GET,
            produces = "application/json")
    public Object getReviewsForUser(@PathVariable String userId, HttpServletRequest request) {
        try {
